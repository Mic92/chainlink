...
type ORM interface {
	...
	FilteredLogs(ctx context.Context, filter query.KeyFilter, sortAndLimit query.LimitAndSort) ([]Log, error)
}
...
func (o *DbORM) FilteredLogs(ctx context.Context, filter query.KeyFilter, limit query.LimitAndSort) ([]Log, error) {
	qs, args, err := (&pgDSLParser{}).buildQuery(o.chainID, filter.Expressions, limit)
	if err != nil {
		return nil, err
	}
	...
	query, sqlArgs, err := o.db.BindNamed(qs, values)
	if err != nil {
		return nil, err
	}
